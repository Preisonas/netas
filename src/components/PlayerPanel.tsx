        ...
        {!session ? (
          <>
            ...
            <Button
              ...
              disabled={loading}
              className="group mt-8 w-full h-12 rounded-sm bg-[#5865F2] text-white hover:bg-[#4752C4] gap-2 transition-all duration-300 hover:shadow-[0_8px_24px_-8px_rgba(88,101,242,0.6)] hover:-translate-y-0.5"
            >
              <svg
                viewBox="0 0 71 55"
                className="h-5 w-5 fill-current transition-transform duration-500 group-hover:scale-110 group-hover:-rotate-12"
                aria-hidden
              >
