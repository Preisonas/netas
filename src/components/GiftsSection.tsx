      ...
      {giftsQuery.isLoading ? (
        ...
        <div className="space-y-4">
          {gifts.map((g) => {
            ...
            const isClaimed = !!g.character_id || !!g.claimed_at;
            ...
            return (
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <span className={`shrink-0 text-[10px] uppercase tracking-wider px-2 py-1 rounded ${statusClass}`}>
                    {statusLabel}
                  </span>
                </div>
                ...
                {isClaimed ? (
                  <div className="rounded-lg bg-secondary/30 p-4 text-center text-sm text-muted-foreground">
                    {isDelivered
                      ? "✅ Dovana pristatyta tavo veikėjui."
                      : "⏳ Dovana priskirta. Pristatymas vyksta serveryje."}
                  </div>
                ) : (
                  <>
                    <div>
