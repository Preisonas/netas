          ...
          <div className="relative container grid lg:grid-cols-2 gap-4 items-center py-24">
            ...
            <div className="hidden lg:block relative h-0 group">
              <img
                ...
                alt=""
                aria-hidden
                className="absolute right-8 top-1/2 -translate-y-1/2 h-[760px] w-auto max-w-none object-contain grayscale hover:grayscale-0 transition-all duration-500 ease-out"
              />
            </div>
